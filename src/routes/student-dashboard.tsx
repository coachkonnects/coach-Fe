...
function StudentDashboard() {
  ...
  const [passkeyMessage, setPasskeyMessage] = useState(
    typeof window !== 'undefined' && localStorage.getItem("hasPasskeyRegistered") === "true" ? "Passkey active for secure login!" : ""
  );
  ...
  const isProfileIncomplete = profile && (!profile.dateOfBirth && !profile.dob || !profile.interests || !profile.district);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50/30 to-orange-50/30 font-sans pb-24 relative">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-bold">{profile?.dateOfBirth || profile?.dob || 'Not provided'}</p>
                  </div>
                </div>
      ...
      {/* Social Media Footer */}
      <div className="mt-4 pb-8 flex flex-col items-center gap-3">
        <p className="text-xs text-slate-400 font-semibold uppercase tracking-widest">Follow us on</p>
        <div className="flex items-center gap-3">
          {/* WhatsApp */}
          <a href="https://whatsapp.com/channel/0029VbBrjCH3LdQYRqt5AI29" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-white border border-slate-100 shadow-sm flex items-center justify-center text-slate-500 hover:bg-[#25D366] hover:text-white hover:scale-110 transition-all duration-200"
            title="WhatsApp">
          ...
          {/* Facebook */}
          <a href="https://www.facebook.com/CoachKonnects" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-white border border-slate-100 shadow-sm flex items-center justify-center text-slate-500 hover:bg-[#1877F2] hover:text-white hover:scale-110 transition-all duration-200"
            title="Facebook">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          {/* Instagram */}
          <a href="https://www.instagram.com/coachkonnects/" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-white border border-slate-100 shadow-sm flex items-center justify-center text-slate-500 hover:bg-[#E4405F] hover:text-white hover:scale-110 transition-all duration-200"
            title="Instagram">
          ...
          {/* YouTube */}
          <a href="https://www.youtube.com/@CoachKonnects" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-white border border-slate-100 shadow-sm flex items-center justify-center text-slate-500 hover:bg-[#FF0000] hover:text-white hover:scale-110 transition-all duration-200"
            title="YouTube">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.07 0 12 0 12s0 3.93.501 5.814a3.016 3.016 0 0 0 2.122 2.136c1.872.55 9.377.55 9.377.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
          </a>
        </div>
